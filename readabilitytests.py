...
class ReadabilityTool:
    ...
    def getReportAll(self, text = ''):
        '''Modified 8-2012 by Eli Omernick to return a dictionary instead of Printing'''
...
#        print '*' * 70
        ...
        # Generate entries for return dict
        return dict(map(lambda (name, func): (name,func(text)), self.tests_given_lang[self.lang].items()))
