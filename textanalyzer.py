...
class textanalyzer(object):
    ...
    def analyzeText(self, text=''):
        '''modified to return a dict instead of printing it. eomernick'''
        ...
        d = {}
        d['Language'] = self.lang
        d['Number of characters:'] = str(charCount)
        d['Number of words:'] = str(wordCount)
        d['Number of sentences:'] = str(sentenceCount)
        d['Number of syllables:'] = str(syllablesCount)
        d['Number of complex words:'] = str(complexwordsCount)
        d['Average words per sentence:'] = str(averageWordsPerSentence)
        return d
...
#            self.lang = NaiveBayes().classifyText(" " .join(words))
        ...
        if self.lang == "unknown" or self.lang == 0:
